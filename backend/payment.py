...
class Payment(Base):
    ...
    # Removed invoice relationship - conflicts with PaymentApplication
...
class PaymentApplication(Base):
    ...
    invoice = relationship("Invoice")  # Removed back_populates - Invoice has "payments" pointing to PaymentApplication
